  ...
  return (
    <div className="border border-[#e5e7eb]">
      <div className="border-b border-[#e5e7eb] px-4 py-2.5">
        <p className="text-[10px] font-semibold uppercase tracking-widest text-[#9ca3af]">Structured memory</p>
          ...
          return (
            <div key={entry.id} className="px-4 py-3">
              <div className="flex items-start justify-between gap-2">
                <p className="font-mono text-[11px] font-semibold text-[#111827]">{entry.key}</p>
                <div className="flex shrink-0 items-center gap-1.5">
                  <span
                    className="border px-1.5 py-[1px] text-[10px] font-semibold uppercase tracking-wide"
                    style={{ borderColor: `${color}40`, color, background: `${color}0d` }}
                  >
                    {entry.scope}
                  </span>
                  {isMasked && (
                    <span className="flex items-center gap-1 border border-[#fcd34d] bg-[#fffbeb] px-1.5 py-[1px] text-[10px] text-[#92400e]">
